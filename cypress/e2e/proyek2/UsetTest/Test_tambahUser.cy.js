describe('User Can Open Login Page', () => {
    it('Login Page Can be Open and have correct specification', () => {
      ...
      cy.get(':nth-child(2) > :nth-child(2) > .input-group > .form-control').type("Admin Test")
      cy.get(':nth-child(3) > .input-group > .form-control').type("admin_test@gmail.com")
      cy.get('#password').type("admintest123")
